...
public interface TestServiceInterface {
    ...
    @GET
    @Path("/runNewTest")
    public abstract String runNewTest(@QueryParam("repoName") String repoName, @QueryParam("testName") String testName) throws IOException, WrongFileTypeException, RepositoryNotFoundException, TestNameNotFoundException;
    ...
    /**
     * function for front end to let tick setter set a new test with certain settings
     * @param	testName 	Name of the test being created
     * @param   checkstyleOpts		list denoting what static tests the setter wants turned on
     */
    @GET
    @Path("/createNewTest")
    public void createNewTest(/* @QueryParam("testName") String testName, @QueryParam("checkstyleOptions") List<String> checkstyleOpts */);
